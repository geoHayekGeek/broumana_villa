    ...
    <div class="row clusters-row">
        ...
        <div class="col-md-4 clickable-div">
            <div class="img-container">
                <img data-src="<?php echo SITE_URL; ?>/assets/images/home/broumana-yard/<?php echo $yardSecondaryImage ?>" alt="Broumana Yard - Divvy - French Cantine - Mallem Arteen" class="clusters-img lazy-img">
            </div>
        ...
        <div class="col-md-4 clickable-div">
            <div class="img-container">
                <img data-src="<?php echo SITE_URL; ?>/assets/images/home/broumana-villa/<?php echo $villaSecondaryImage ?>" alt="Broumana Villa - Best Restaurants in lebanon" class="clusters-img lazy-img">
            </div>
            <div class="animated-divider"></div>
        ...
        <div class="col-md-4 clickable-div">
            <div class="img-container">
                <img data-src="<?php echo SITE_URL; ?>/assets/images/home/broumana-square/<?php echo $squareSecondaryImage ?>" alt="Broumana Square - Ahwak - Obi - Lina's" class="clusters-img lazy-img">
            </div>
            <div class="animated-divider"></div>
